...
class showWorkoutChosen extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`/workout/chosen/${this.props.match.params.id}`)
            ...
            axios.get('/workoutUser/user/'+this.state.UserId)
                .then(response =>{
                    this.setState({
    ...
    selectWorkout(){
        ...
        if(this.state.exists){
            axios.put(`/workoutUser/${this.state.existId}`,message)
                .then(response => {
                    let message = {
                    ...
                    axios.patch(`/workout/addUsers`, message)
                        .then(response => {
                            SubmissionAlert2();
            ...
            axios.post(`/workoutUser/`,message)
                .then(response => {
                    let message = {
                        workoutId:this.state.id,
                        //userId:"41224d776a326fb40f000002"
