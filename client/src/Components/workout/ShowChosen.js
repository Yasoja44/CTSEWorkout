...
class showWorkoutChosen extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`http://10.48.2.244:5000/workout/chosen/${this.props.match.params.id}`)
            .then(response => {
                this.setState({
            ...
            axios.get('http://10.48.2.244:5000/workoutUser/user/'+this.state.UserId)
                .then(response =>{
                    this.setState({
    ...
    selectWorkout(){
        ...
        if(this.state.exists){
            axios.put(`http://10.48.2.244:5000/workoutUser/${this.state.existId}`,message)
                .then(response => {
                    let message = {
                    ...
                    axios.patch(`http://10.48.2.244:5000/workout/addUsers`, message)
                        .then(response => {
                            SubmissionAlert2();
            ...
            axios.post(`http://10.48.2.244:5000/workoutUser/`,message)
                .then(response => {
                    let message = {
                        workoutId:this.state.id,
                        //userId:"41224d776a326fb40f000002"
